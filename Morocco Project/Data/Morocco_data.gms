...
parameter SpecifiedAnnualDemand(r,f,y) / #units: time of use during the year
...
#COMMERCIAL (TRADE) ELECTRICITY DEMAND IS ASSUMED TO BE NULL (?)
...
#Reported source: Brinkerink     M,     Deane     P     (2020).    PLEXOS     World     2015.    Harvard     Dataverse,     V3; Toktarova A, Gruber L, Hlusiak M, et al (2019). Long term load projection in high resolution for all countriesglobally. International Journal of Electrical Power and Energy Systems 111: 160–181
